...
module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		watch: {
			...
			livereload: {
				files: [
					...
					'!{.tmp,<%= yeoman.client %>}/translations.js',
		...
		nggettext_extract: {
			pot:{
				files:{'client/po/template.pot':['{.tmp,dist}/**/*.html','client/index.html']}
			}
		},
		nggettext_compile: {
			all:{
				files:{'client/translations.js':['client/po/*.po']}
			}
		},
		...
		copy: {
			dist: {
				files: [{
					...
					expand: true,
					cwd: '<%= yeoman.client %>/bower_components/semantic-ui/dist/themes',
