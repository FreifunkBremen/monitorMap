  ...
  var loop = function(){
        ...
        var g = {nodes:0,clients:0,clients24:0,clients50:0,rx_bytes:0,rx_packets:0,tx_bytes:0,tx_packets:0,mem_total:0};
          ...
          if(data[i].node_id){
            ...
            g.clients24+=Math.ceil(data[i].clients.wifi24);
            g.clients50+=Math.ceil(data[i].clients.wifi50);
            ...
            tmp = {
              ...
              values:{
                ...
                clients24:Math.ceil(data[i].clients.wifi24),
                clients50:Math.ceil(data[i].clients.wifi50),
                load:data[i].loadavg,
                uptime:Math.ceil(data[i].uptime),
                ...
                for(var j in nodes){
                  if(data[i].node_id == nodes[j].mac.split(":").join('')){
                    ...
                    nodes[j].updateAttributes({
                      ...
                      status:true,
                      client_50:Math.ceil(data[i].clients.wifi50),
                      client_24:Math.ceil(data[i].clients.wifi24),
